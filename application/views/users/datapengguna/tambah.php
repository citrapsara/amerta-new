            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" action="" data-parsley-validate="true" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-9">
                      <select class="form-control default-select2" name="divisi" selected="<?php echo $query->divisi; ?>" required>
                        <option value="">- Pilih -</option>
                        <option value="admin">Administrasi</option>
                        <option value="yankumham">Pelayanan Hukum dan HAM</option>
                        <option value="pas">Pemasyarakatan</option>
                        <option value="imi">Keimigrasian</option>
                      </select>
                    </div>
                  </div>
                  <div class="form-group">
